...
export default function DeteksiPage() {
  ...
  const calculateHarvest = async () => {
    ...
    try {
      ...
      const areaInM2 = hectareToSquareMeter(
        Number.parseFloat(harvestData.landArea)
      );
                    ...
                    <div className="mt-6 space-y-3 animate-in fade-in-50">
                      <div className="p-4 bg-primary/10 border-l-4 border-primary rounded-lg">
                        <p className="text-sm text-foreground">
                          ...
                          <span className="text-primary font-bold">
                            {(
                              Number(harvestData.estimatedYieldKg) / 1000
                            ).toFixed(2)}{" "}
                            ton
                          </span>
                          )
                      ...
                      {harvestData.estimatedIncome && (
                        <div className="p-4 bg-accent/10 border-l-4 border-accent rounded-lg">
                          <p className="text-sm text-foreground">
                            ...
                            jual {formatRupiah(harvestData.pricePerKg || "0")}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  <div>
                    <label className="block text-sm font-semibold text-foreground mb-3">
                      Ambil atau Unggah Gambar
                    </label>
                    <div className="space-y-3">
                      <CameraCapture
                        onCapture={handleImageCapture}
                        disabled={diseaseData.imagePreview !== null}
                      />
                      <ImageUploader
